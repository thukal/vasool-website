        ...
        <div className="grid lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-5 leading-tight">
              {t("home.staff.title1")}{" "}
              <span className="text-gradient">{t("home.staff.title2")}</span>
            </h2>
          ...
          <div className="grid grid-cols-2 gap-3.5 sm:gap-4">
            {staffCards.map((card, idx) => (
              <div
                key={card.titleKey}
                className={`bg-card rounded-2xl p-5 sm:p-6 border border-border/60 shadow-card hover:shadow-card-hover hover:border-secondary/20 transition-all duration-300 ${
