...
const storyParagraphs = [
  'The name <strong class="text-foreground">Thukal</strong> — துகழ் — means "particle" in Tamil. It reflects how we think about building technology: small, precise components that come together to form something powerful. Just like the particles that scatter and reassemble above, every feature in our platform is a focused piece of a larger whole.',
  ...
  'Together, Thukal and Vasool represent our philosophy: build precise, well-crafted tools (துகழ்) that transform how collections (வசூல்) work on the ground. We started by watching how microfinance actually operates — paper registers, WhatsApp groups, manual cash reconciliation every evening — and built a platform that replaces all of it with a single, purpose-built system.',
